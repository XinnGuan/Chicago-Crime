...
```{r}
Binary_pred_df <- Crime_data %>% select(c("ID","Hour","Time","WeekDay","DayOfMonth","DayOfYear","Primary.Type","Arrest","District"))
#???location variables
```
...
```{r}
base_m_under <- train(Arrest ~ District + DayOfYear + Hour + Primary.Type, data = train_balanced_under, method = "glm", family = "binomial", trControl = ctrl, metric = "ROC")
